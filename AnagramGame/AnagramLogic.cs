...
public static class GameAnagram
{
    ...
    static void PlayLevel(List<string> baseWords)
    {
        ...
        while (true)
        {
            ...
            List<string> allWords = anagrams.ContainsKey(rootWord) ? anagrams[rootWord] : new List<string> { rootWord };
    ...
    static string Shuffle(string input)
    {
        ...
        // Якщо випадково вийшло те саме слово — перетасуємо ще раз
